...
function Header() {
  ...
  return (
    <header className="">
          ...
          <div className="hidden lg:w-full lg:flex lg:flex-row lg:justify-between items-center">
            <div>
              <ul className="flex flex-row font-inter text-tertiary font-medium">
                <li className="px-5 font-semibold hover:text-zinc-400 transition-all ease-in duration-200">
                  Catégories
                </li>
                <li className="px-5 font-semibold hover:text-zinc-400 transition-all ease-in duration-200">
                  Bons plans
            ...
            <div className="relative w-xl">
              <svg
                ...
                viewBox="0 0 16 16"
                fill="currentColor"
                className="size-6 absolute right-4 top-1.5 text-gray-500"
              >
                <path
                  fill-rule="evenodd"
              ...
              <input
                type="text"
                className=" w-full py-1 px-3 border-2 focus-visible:outline-blue-600 border-gray-500 rounded-xl"
      ...
      <nav
        id="burgerMenu"
        className="absolute z-10 right-0 w-full h-full bg-primary shadow-lg transform translate-x-full transition-transform duration-300 ease-in-out lg:hidden"
      >
        <div className="relative p-4 w-4xs mx-auto">
          <svg
            ...
            viewBox="0 0 16 16"
            fill="currentColor"
            className="size-6 absolute right-6 top-5 text-gray-500"
          >
            <path
              fill-rule="evenodd"
              d="M9.965 11.026a5 5 0 1 1 1.06-1.06l2.755 2.754a.75.75 0 1 1-1.06 1.06l-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z"
